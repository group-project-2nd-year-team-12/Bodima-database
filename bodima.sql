...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2020 at 06:54 AM
...
INSERT INTO `confirm_rent` (`rent_id`, `Bid`, `BOid`, `B_post_id`, `is_paid`, `keymoneyAmount`, `payment_method`, `payment_date`, `agreement`) VALUES
(24, 37, 3, 1, 1, 10000, 'online', '2020-11-23 16:04:35', ' '),
(25, 38, 3, 1, 1, 10000, 'online', '2020-11-23 16:09:26', ' '),
(26, 39, 3, 1, 1, 10000, 'online', '2020-11-23 16:13:37', ' '),
(27, 40, 3, 1, 1, 10000, 'online', '2020-11-23 16:17:07', ' ');
...
(81, 'reshmikaediriweera1997@gmail.com', 3, 1, 'I am Reshmika.I  like to get the your Dalthara boarding place and would like to request  your boardi', 5, '2020-11-20 00:00:00'),
(82, 'reshmikaediriweera1997@gmail.com', 1, 2, 'I am Reshmika.I  like to get the your kotuwa boarding place and would like to request  your boarding', 5, '2020-11-20 00:00:00'),
(83, 'reshmikaediriweera1997@gmail.com', 1, 3, 'I am Reshmika.I  like to get the your Moratuwa boarding place and would like to request  your boardi', 1, '2020-11-20 00:00:00'),
(100, 'reshmikaediriweera1997@gmail.com', 3, 4, 'sssssssssssss', 5, '2020-11-22 16:12:09'),
...
--
ALTER TABLE `confirm_rent`
  ADD CONSTRAINT `confirm_rent_ibfk_1` FOREIGN KEY (`Bid`) REFERENCES `boarder` (`Bid`) ON DELETE CASCADE ON UPDATE CASCADE,
